...
Inside the publishing process of a new book, deciding the best {\em print run}, i.e. the number of copies to be printed and delivered to bookstores, is a very challenging problem.

To this end, it is extremely important to develop accurate predictive models which could forecast the future sales a new book will achieve, in order to optimise production schedules: to improve the publishing company profits and to minimise losses \cite{Zhao2001}, due both to the excess or to the scarcity of units.
%
