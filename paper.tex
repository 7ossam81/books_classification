...
In this paper, we transform this problem into a classification one, defining different sales levels i.e. classes. The obtained results will be easier to interpret by publishers than other black-box techniques, so they will consider them in their decision process.
